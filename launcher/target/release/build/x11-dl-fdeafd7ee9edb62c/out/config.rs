...
pub const x11: Option<&'static str> = Some("/nix/store/7gwd2kvkx1s369cwiv5z4x2xjxbppav6-libx11-1.8.13/lib");
pub const xlib_xcb: Option<&'static str> = Some("/nix/store/7gwd2kvkx1s369cwiv5z4x2xjxbppav6-libx11-1.8.13/lib");
